 ...
 * @author rodrigo
 */
public class TP382vista extends javax.swing.JFrame {

    /**
     * Creates new form TP382vista
     */
    public TP382vista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TP382vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TP382vista().setVisible(true);
            }
        });
    }
